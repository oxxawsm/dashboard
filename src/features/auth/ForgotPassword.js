            ...
            <div className='card mx-auto w-full max-w-xl'>
                <div className='py-24 px-10'>
...

                    {
                        linkSent &&
                        <>
                            <div className='text-center mt-8'><img className='inline-block w-24 text-success' src='sent-link.png' /></div>
                            <p className='mt-4 mb-10 font-semibold text-center'>Отправили ссылку для сброса пароля, проверьте свою почту</p>
                            <div className='text-center mt-4'><Link to='/login'><button className='btn btn-block bg-violet-300 dark:bg-violet-700 text-black hover:bg-violet-400'>Вход</button></Link></div>
...

                    {
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => submitForm(e)}>
                                ...
                                <button
                                    type='submit'
                                    className={'btn mt-2 w-full text-black bg-violet-300 dark:bg-violet-700 hover:bg-violet-400' + (loading ? ' loading' : '')}
                                >
                                    Сбросить пароль
                                </button>
